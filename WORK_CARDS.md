...
1. festivals.json,**首版 37 个节日原型 × 每个 2-3 张卡 ≈ 90 张**(六谱系全覆盖,脑已盘好):
   - **水与火**(体感最直接):泼水节(清迈/西双版纳)、番茄节(布尼奥尔)、火节(瓦伦西亚)、篝火夜(英国)、排灯节(印度,灯)、水灯节(泰)、仲夏节(北欧)
   - **季节轮转**:樱花前线(纬度推移)、红叶前线、收获节、冬至、白夜、春节
   - **生死与记忆**:亡灵节(墨)、清明、盂兰盆(日)、万圣节、拉迪什之夜(墨12月)
   - **宗教大日子**:开斋节/宰牲节(**伊斯兰历,年漂 ~11 天,必须用真实换算表 2026-2035,不许写死公历**)、圣诞、复活节、卫塞节、大壶节
   - **城市奇观**:威尼斯面具、里约狂欢、诺丁山、慕尼黑啤酒节、龙舟、奔牛、印度风筝节
   - **极地与自然**:极夜节、午夜太阳节、哈尔滨采冰、帝王蝶归来(墨11-3月)、极光季
